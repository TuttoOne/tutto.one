...
export const SITE_PAGES: SitePage[] = [
  {
    ...
    summary: "We build agents. The way in is a 90-minute guided lesson.",
    detail:
      "The site's front door. AI is more than an advanced search engine: with tools it can do work. It can read data, create documents and run calculations. We don't replace people. We help them get the most out of their time with new skills and AI assistants that don't sleep. The page walks the reader through the sequence they are on — chat, workspace, agent — and prices the guided lesson that starts it. The booking on this page is the 90-minute guided lesson, which is paid, not the free 15-minute intro the other pages book.",
    offering: true,
  },
  {
    path: "/services",
  ...
  },
  {
    ...
    summary: "One hour that changes how you think about AI.",
    detail:
      "Praxis is Tutto's hands-on training. You don't need a proprietary platform or an account with us — an AI assistant subscription and a free code editor, both pointed at the same folder on your machine. That folder, and what's inside it, is your app. Every CTA on the page opens a conversation rather than selling an hour.",
    offering: true,
  },
  {
    path: "/calendar",
