...
function CoursesSection() {
  ...
  const MOCK_COURSES: Record<
    string,
    { meta: Record<string, any>; path: string }[]
  > = {
    "praxis-foundations": [
      {
        meta: {
          ...
          description:
            "The mental model behind Praxis - what the folder system is and why it works.",
        },
        path: "courses/praxis-foundations/index.md",
      },
      {
        meta: { order: 1, title: "The folder is the app" },
        path: "courses/praxis-foundations/01-the-folder-is-the-app.md",
      },
      {
        meta: { order: 2, title: "SKILL.md - writing instructions that stick" },
        path: "courses/praxis-foundations/02-skill-md.md",
      },
      {
        meta: { order: 3, title: "Your first run.py" },
        path: "courses/praxis-foundations/03-first-run-py.md",
      },
      {
        meta: { order: 4, title: "Working with documents" },
        path: "courses/praxis-foundations/04-working-with-documents.md",
      },
    ],
    "train-the-trainer": [
      {
        meta: {
          ...
          title: "Course overview",
          description:
            "How to deliver a Praxis session - facilitation, pacing, and handling different rooms.",
        },
        path: "courses/train-the-trainer/index.md",
      },
      {
        meta: { order: 1, title: "Reading the room" },
        path: "courses/train-the-trainer/01-reading-the-room.md",
      },
      {
        meta: { order: 2, title: "The intake conversation" },
        path: "courses/train-the-trainer/02-intake-conversation.md",
      },
      {
        meta: { order: 3, title: "Handling the practical half" },
        path: "courses/train-the-trainer/03-practical-half.md",
      },
    ],
  };
    ...
    <section className="py-16 bg-gray-50 border-t border-gray-200">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <p className="text-gray-500 text-sm mb-8">
          Work through the concepts at your own pace before a live session, or
          revisit them after.
        </p>
        <div className="grid sm:grid-cols-2 gap-6">
          {Object.entries(display).map(([slug, lessons]) => {
            const overview = lessons.find(
              (l) => l.meta.order === "0" || l.meta.order === 0,
            );
      ...
      <div className="px-wrap" style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        >
          ...
          <p
            ...
            className="text-[36px]">
            Coaching, teaching, and guiding people through what setting up AI
            looks like for them.
          </p>
          <p
            style={{
          ...
          >
            Every session is built around your context, your files, and your
            work. No generic demos. You leave with a working system and the
            understanding to keep building on your own.
          </p>
        </div>
        ...
        >
          <span style={{ ...CAPS, fontSize: 10, color: "#1a1a1a" }}>Praxis: What does it mean for you?</span>
        ...
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          <p
            ...
            className="text-left">
            A &nbsp;M e n t a l &nbsp;M o d e l &nbsp;i n &nbsp;O n e &nbsp;P a
            g e
          </p>
        </div>
        ...
        <div style={{ maxWidth: 620, marginBottom: 64 }}>
          ...
          >
            You don't need a proprietary platform or an account with us. The
            only thing you'll need to subscribe to is Claude - about $20 a month
            - and a free code editor. Point all three at the same folder on your
            machine. That folder, and what's inside it, is your app.
          </p>
        </div>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div className="px-connector">
            ...
            >
              <span style={{ ...MONO, fontSize: 11, color: "#5a5248" }}>
            ...
            <div>
              ...
              >
                ...
                {[
                  {
                    name: "SKILL.md",
                    label: "the rules · written in plain English",
                    tag: "A",
                  },
                  {
                    name: "run.py",
                    label: "the script · the work it does",
                    tag: "B",
                  },
                  {
                    name: "documents/",
                    label: "your data · the inputs",
                    tag: "C",
                  },
                ...
                >
                  <span style={{ ...MONO, fontSize: 10, color: "#a8a092" }}>
                    4 items · ~12 KB
                  </span>
                  <span style={{ ...MONO, fontSize: 10, color: "#a8a092" }}>
                    opens in any editor · runs anywhere
                  </span>
                </div>
              </div>
            </div>
        ...
        >
          ...
          >
            Eight sessions over two months. For people who have used AI in a
            chat box and want to go further. You will build small, working tools
            that do your repetitive work for you, in plain English, with someone
            sitting beside you who has done it before.
          </p>
        </div>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div className="pp-cols-2">
            {[
              {
                label: "Hit the ceiling",
                body: "You have used AI as a chat assistant and reached the limit of what copy-and-paste can do.",
              },
              {
                label: "A task that repeats",
                body: "You have a task you do every week that you suspect a machine could do for you.",
              },
              {
                label: "Not a developer",
                body: "You are not trying to become one. You want to make useful things. That is a different goal, and this programme is built around it.",
              },
              {
                label: "Rather be shown",
                body: "You would rather be shown than left alone with a pile of conflicting videos. It works for professionals, small teams, and anyone whose week is full of work that repeats.",
              },
            ].map((item) => (
              <div
                key={item.label}
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ maxWidth: 700 }}>
            {[
              {
                label: "Tailored to your actual work",
                body: "Not a generic example you have to translate. We start with the task that eats your week and build from there.",
              },
              {
                label: "We meet you where you are",
                body: "No burying you in tools you have never heard of to look clever. Every session starts from where you actually are.",
              },
              {
                label: "The fiddly parts are where a guide earns their keep",
                body: "Installing the tool, the first setup, the moment something breaks: that is exactly the part the free videos skip, and exactly where most people quietly give up.",
              },
            ].map((item, i) => (
              <div
                key={item.label}
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          >
            Weekly, over roughly two months. The first six get you to a
            confident, independent builder. The last two take you deeper, into
            the kind of work that usually needs a developer.
          </p>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          >
            ...
            >
              A certificate confirming you completed the programme - and, more
              to the point, the tools you built during it. The certificate
              records what you made, not just that you turned up. That is the
              proof that matters.
            </p>
            <p
              style={{
            ...
            >
              A note on honesty, because it sets the right expectation: you will
              get most of the way there yourself. On anything complex, the last
              stretch you finish by hand or hand off. Even getting most of the
              way is a large saving on how the work is done today - and that is
              the saving we are after.
            </p>
          </div>
        </div>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div className="pp-cols-2">
            {[
              {
                label: "Format",
                body: "One-to-one or small group. You choose what suits you.",
              },
              {
                label: "Cadence",
                body: "One session a week, about an hour each, over roughly two months. A short practice task between each session.",
              },
              {
                label: "Where",
                body: "Online, via Teams or Google Meet. In person on request.",
              },
              {
                label: "What you need",
                body: "A laptop - Mac or Windows. A Claude account. We set up everything else together in the first session.",
              },
            ].map((item) => (
              <div
                key={item.label}
        ...
        <div style={{ marginBottom: 56, paddingTop: 8 }}>
          <p
            style={{ ...CAPS, fontSize: 9, color: "#a8a092", marginBottom: 20 }}
          >
          ...
          >
            It will make you someone who can build genuinely useful things, and
            who knows when a job is big enough to call in a developer, and how
            to brief them when you do. That is a more valuable place to stand
            than it sounds.
          </p>
        </div>
        ...
        >
          ...
          >
            Praxis is the loop of putting theory into practice, then letting
            what you learn from doing it sharpen the theory.
          </p>
          <p
            style={{
              ...INTER,
          ...
          >
            Praxis comes from the Greek <em>prâxis</em> (πρᾶξις), meaning
            "doing" or "action," from the verb <em>prattein</em>, "to do" or "to
            act." Aristotle used it to distinguish lived action from two other
            modes of human activity - <em>theoria</em> (contemplation) and{" "}
            <em>poiesis</em> (making). Where <em>poiesis</em> produces an object
            outside itself, praxis is action whose end lies in the doing itself,
            the conduct of a life rather than the manufacture of a thing.
          </p>
        </div>

        {/* Doc footer */}
        <div className="px-footer-bar">
          <span style={{ ...CAPS, fontSize: 9, color: "#1a1a1a" }}>
            Praxis · Client Training
          </span>
          <span style={{ ...CAPS, fontSize: 9, color: "#1a1a1a" }}>
