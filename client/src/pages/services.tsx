...
const services = [
  {
    ...
    features: ["Audit of Notion/Confluence/Drive", "API Readiness Score", "Knowledge Graph Architecture"],
    price: "Starts at $5k"
  },
  {
    title: "AI Agent Architecture",
    description: "Design and implement specific agent workflows to automate core business processes using your newly structured data.",
    ...
    <Layout>
      <div className="max-w-5xl mx-auto px-6 py-12">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-serif font-bold mb-6">Services</h1>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div key={index} className="bg-card border border-border/60 rounded-2xl p-8 hover:shadow-lg transition-all hover:-translate-y-1 duration-300 flex flex-col">
              ...
              <div className="mt-auto">
                <div className="text-sm font-medium text-muted-foreground mb-4">{service.price}</div>
                <Button className="w-full rounded-full" variant={index === 1 ? "default" : "outline"}>
                    Inquire
                </Button>
              </div>
            </div>
        ...
        <div className="mt-20 text-center bg-secondary/30 rounded-3xl p-12">
           ...
           <p className="text-muted-foreground mb-8">Run the diagnostic in the chat interface to get a personalized recommendation.</p>
           <Button className="rounded-full px-8 py-6 text-lg" asChild>
               <a href="/">Run Diagnostic <ArrowRight className="ml-2"/></a>
           </Button>
        </div>
      </div>
    </Layout>
