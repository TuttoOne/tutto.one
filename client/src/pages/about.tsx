    ...
    <Layout>
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-lg prose-neutral max-w-none font-serif leading-relaxed text-muted-foreground">
          ...
          <p className="mb-6">
            Most companies treat their internal knowledge like oral history. It lives in Slack threads, quick calls, and messy Google Docs. Humans can navigate this ambiguity. AI cannot.
          </p>
          <p className="mb-10">
            My work is to help you structure that chaos, turning your implicit organizational knowledge into explicit, machine-consumable assets.
          </p>

          <h3 className="text-2xl font-bold text-foreground mb-4 mt-12">Why "Chat-First"?</h3>
          <p className="mb-6">
            I built this website as a chat interface because I believe conversational UI is the future of software. It's direct, personal, and efficient.
          </p>
        </div>
