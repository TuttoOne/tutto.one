        ...
        >
          ...
          <div className="space-y-6 print:space-y-4">
            <Section label="Ce que je fais">
              <p>
                Les PME produisent et reproduisent les mêmes documents chaque semaine : devis,
                dossiers qualité, certificats fournisseurs, dossiers de financement, comptes rendus
                réglementaires. Personne ne compte ce que cela coûte. Je le compte, je dis ce qui
                peut être allégé, et je construis les systèmes qui l'allègent.
              </p>
            </Section>
            ...
            <Section label="Ce que j'ai construit">
              ...
              <p>
                ...
                , pour d'autres raisons : normes sous licence, données sous contrôle export,
                exigences clients. Je l'ai déjà résolue une fois.
              </p>
            </Section>

            <Section label="Formation">
              <p>
                Je forme des dirigeants et des équipes à l'usage professionnel des outils d'IA : non
                pas une démonstration, mais un travail réel mené en séance, sur leurs propres
                documents, jusqu'à un résultat qu'ils repartent avec.
              </p>
              <p>
                <strong className="text-foreground font-semibold">
            ...
            <Section label="La démonstration">
              <p>
                Je travaille sur <strong className="text-foreground font-semibold">l'Atelier Vallon</strong>,
                un atelier de mécanique de précision{" "}
                <strong className="text-foreground font-semibold">fictif</strong> : douze salariés,
                ISO 9001 et EN 9100, environ 300 documents, avec des non-conformités volontairement
                introduites.
              </p>
              <p>
                <strong className="text-foreground font-semibold">
              ...
              <ul className="space-y-3 print:space-y-2">
                ...
                <li className="flex gap-3">
                  ...
                  <span>
                    ...
                    . Mon français écrit est assuré ; mon français parlé progresse et reste simple.
                  </span>
                </li>
              </ul>
            </Section>
