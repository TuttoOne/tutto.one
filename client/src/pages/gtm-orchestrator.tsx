...
const CAPS: React.CSSProperties = { ...{ fontFamily: "'Inter', -apple-system, sans-serif" }, textTransform: "uppercase", letterSpacing: "0.12em" };
  ...
  return (
    <div style={{ width: 48, height: 48, borderRadius: 12, background: "#ede8e1", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 16 }}>
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <line x1="14" y1="13.5" x2="20" y2="19.5" stroke={AMBER} strokeWidth="2" strokeLinecap="round"/>
        <line x1="7" y1="9" x2="13" y2="9" stroke={TEXT} strokeWidth="1.2" strokeLinecap="round"/>
        <line x1="10" y1="6" x2="10" y2="12" stroke={TEXT} strokeWidth="1.2" strokeLinecap="round"/>
      </svg>
    </div>
  );
}
...
function WriteIcon() {
  return (
    <div style={{ width: 48, height: 48, borderRadius: 12, background: "#ede8e1", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 16 }}>
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M4 20h4l10-10-4-4L4 16v4z" stroke={AMBER} strokeWidth="1.5" strokeLinejoin="round"/>
        <path d="M14 6l4 4" stroke={AMBER} strokeWidth="1.4" strokeLinecap="round"/>
        <path d="M16 4l2 2" stroke={AMBER} strokeWidth="1.2" strokeLinecap="round"/>
        <line x1="7" y1="14" x2="10" y2="17" stroke={TEXT} strokeWidth="1.1" strokeLinecap="round"/>
      </svg>
    </div>
  );
}
...
function SendIcon() {
  return (
    <div style={{ width: 48, height: 48, borderRadius: 12, background: "#ede8e1", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 16 }}>
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M3 12L21 4l-4 17-6-7-8-2z" stroke={AMBER} strokeWidth="1.5" strokeLinejoin="round"/>
        <line x1="14" y1="10" x2="11" y2="14" stroke={TEXT} strokeWidth="1.2" strokeLinecap="round"/>
      </svg>
    </div>
  );
}
...
function IntegrateIcon() {
  return (
    <div style={{ width: 48, height: 48, borderRadius: 12, background: "#ede8e1", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 16 }}>
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <rect x="2" y="4" width="7" height="5" rx="1.5" stroke={AMBER} strokeWidth="1.4"/>
        <rect x="15" y="4" width="7" height="5" rx="1.5" stroke={TEXT} strokeWidth="1.4"/>
        <rect x="8.5" y="15" width="7" height="5" rx="1.5" stroke={TEXT} strokeWidth="1.4"/>
        <line x1="5.5" y1="9" x2="5.5" y2="18" stroke={TEXT} strokeWidth="1.1" strokeDasharray="2 1.5"/>
        <line x1="18.5" y1="9" x2="18.5" y2="18" stroke={TEXT} strokeWidth="1.1" strokeDasharray="2 1.5"/>
        <line x1="5.5" y1="17.5" x2="9" y2="17.5" stroke={TEXT} strokeWidth="1.1"/>
        <line x1="15" y1="17.5" x2="18.5" y2="17.5" stroke={TEXT} strokeWidth="1.1"/>
      </svg>
    </div>
  );
}
  ...
  return (
    <div style={{ width: 48, height: 48, borderRadius: 12, background: "#ede8e1", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 16 }}>
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <line x1="7.5" y1="12" x2="9.5" y2="12" stroke={TEXT} strokeWidth="1.3" strokeLinecap="round"/>
        <line x1="14.5" y1="12" x2="16.5" y2="12" stroke={TEXT} strokeWidth="1.3" strokeLinecap="round"/>
        <path d="M5 9 L5 7 L19 7 L19 9" stroke={TEXT} strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" opacity="0.4"/>
      </svg>
    </div>
  );
}
...
const stats = [
  ...
  { value: "3", label: "Custom integrations built (HubSpot, Apollo, Licence portal)" },
    ...
    <div style={{ background: BG, minHeight: "100vh", ...INTER }}>
      ...
      <div className="gtm-wrap" style={{ maxWidth: 960, margin: "0 auto" }}>
        ...
        <div style={{ borderRadius: 12, background: DARK, padding: "clamp(28px, 5vw, 52px)", marginBottom: 56, marginTop: 32 }}>
          <p style={{ ...CAPS, fontSize: 9, color: AMBER, letterSpacing: "0.14em", marginBottom: 16 }}>GTM Orchestrator</p>
          ...
          <p style={{ ...INTER, fontSize: 15, lineHeight: 1.8, color: "rgba(246,241,234,0.65)", maxWidth: 600 }}>
        ...
        {/* The Problem */}
        <div style={{ border: `1px solid ${BORDER}`, borderRadius: 10, padding: "28px", background: CARD, marginBottom: 48 }}>
          <p style={{ ...CAPS, fontSize: 9, color: MUTED, marginBottom: 14 }}>The Problem</p>
          <p style={{ ...ROBOTO, fontSize: "clamp(15px, 2vw, 19px)", fontWeight: 700, color: DARK, lineHeight: 1.45, marginBottom: 16 }}>
            Personalised outreach at scale is impossible by hand. Generic templates get ignored.
          </p>
          <p style={{ ...INTER, fontSize: 13, lineHeight: 1.8, color: MUTED, maxWidth: 660 }}>
        ...
        <div style={{ marginBottom: 48 }}>
          <div style={{ borderRadius: 10, background: "#2a2a2a", padding: "18px 24px", marginBottom: 20 }}>
            <p style={{ ...CAPS, fontSize: 9, color: "rgba(255,255,255,0.4)", marginBottom: 6 }}>Metrics</p>
            <h2 style={{ ...ROBOTO, fontSize: "clamp(15px, 2.2vw, 20px)", fontWeight: 800, color: "#f6f1ea" }}>By the numbers</h2>
          </div>
          <div className="gtm-stats">
            {stats.map(({ value, label }) => (
              <div key={label} style={{ border: `1px solid ${BORDER}`, borderRadius: 10, padding: "18px 16px", background: CARD }}>
                <p style={{ ...ROBOTO, fontSize: "clamp(20px, 3vw, 28px)", fontWeight: 900, color: AMBER, lineHeight: 1, marginBottom: 8 }}>{value}</p>
                <p style={{ ...INTER, fontSize: 11, lineHeight: 1.55, color: MUTED }}>{label}</p>
              </div>
            ))}
          </div>
          <p style={{ ...INTER, fontSize: 11, color: MUTED, marginTop: 12, fontStyle: "italic" }}>
        ...
        <div style={{ marginBottom: 48 }}>
          <div style={{ borderRadius: 10, background: "#2a2a2a", padding: "18px 24px", marginBottom: 20 }}>
            <p style={{ ...CAPS, fontSize: 9, color: "rgba(255,255,255,0.4)", marginBottom: 6 }}>Architecture</p>
            <h2 style={{ ...ROBOTO, fontSize: "clamp(15px, 2.2vw, 20px)", fontWeight: 800, color: "#f6f1ea" }}>Privacy and data flow</h2>
          </div>
          <div style={{ border: `1px solid ${BORDER}`, borderRadius: 10, padding: "24px", background: CARD, marginBottom: 14 }}>
            <p style={{ ...INTER, fontSize: 13, lineHeight: 1.8, color: TEXT, marginBottom: 0 }}>
          ...
          <div className="gtm-flows">
            {([
              ...
              <div key={label} style={{ border: `1px solid ${BORDER}`, borderRadius: 10, padding: "20px 18px", background: CARD, borderTop: `3px solid ${color}` }}>
                <p style={{ ...CAPS, fontSize: 9, color, marginBottom: 10 }}>{label}</p>
                <p style={{ ...INTER, fontSize: 12, lineHeight: 1.75, color: MUTED }}>{body}</p>
              </div>
            ))}
          </div>
          <div style={{ border: `1px solid ${BORDER}`, borderRadius: 10, padding: "20px 22px", background: CARD, marginTop: 14 }}>
        ...
        <div style={{ marginBottom: 48 }}>
          <div style={{ borderRadius: 10, background: "#2a2a2a", padding: "18px 24px", marginBottom: 20 }}>
            <p style={{ ...CAPS, fontSize: 9, color: "rgba(255,255,255,0.4)", marginBottom: 6 }}>Technology</p>
            <h2 style={{ ...ROBOTO, fontSize: "clamp(15px, 2.2vw, 20px)", fontWeight: 800, color: "#f6f1ea" }}>Stack</h2>
          </div>
          <div style={{ border: `1px solid ${BORDER}`, borderRadius: 10, padding: "24px 22px", background: CARD }}>
            {([
              { label: "Hardware", value: "NVIDIA DGX Spark — GB10 Superchip, 128GB unified memory, NVMe storage. Runs entirely on-device." },
              { label: "AI Models", value: "Open-weight models locally for drafting, research, and editorial gates. Claude (Opus) reached headlessly only when frontier reasoning is required." },
              { label: "Orchestration", value: "Claude running headlessly as the orchestrator — routes each step to a local model or the frontier model through a single LLM client." },
              { label: "Backend", value: "Python (FastAPI) services, a sequence scheduler with send-claim/idempotency architecture, and a React dashboard." },
              { label: "Integrations", value: "Reverse-engineered session-replay bridges to HubSpot CRM, Apollo.io, and the TSplus licence portal where no developer API exists." },
              { label: "Security", value: "Hardened Linux, TOTP-gated administrative access, least-privilege read-only roles, and full audit logging of sends and model egress." },
              { label: "Access", value: "Tailscale peer-to-peer VPN — secure remote access without port forwarding." },
            ]).map(({ label, value }, i, arr) => (
              <div key={label} style={{ marginBottom: i < arr.length - 1 ? 14 : 0, paddingBottom: i < arr.length - 1 ? 14 : 0, borderBottom: i < arr.length - 1 ? `1px solid ${BORDER}` : "none" }}>
                <p style={{ ...CAPS, fontSize: 8, color: AMBER, marginBottom: 4 }}>{label}</p>
                <p style={{ ...INTER, fontSize: 12, lineHeight: 1.65, color: TEXT }}>{value}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ borderRadius: 12, background: DARK, padding: "clamp(24px, 4vw, 40px)" }}>
          ...
          <p style={{ ...INTER, fontSize: 13, lineHeight: 1.75, color: "rgba(246,241,234,0.6)", maxWidth: 560 }}>
