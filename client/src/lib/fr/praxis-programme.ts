...
export const PRAXIS_PROGRAMME_FR: FrDict = {
  ...
  "On what this will not do": "Ce que ce programme ne fera pas",
  "It will not make you a software engineer in eight weeks.":
    "Il ne fera pas de vous un ingénieur logiciel en huit semaines.",
  "What comes next": "La suite",
  "Become a Praxis trainer.": "Devenez formateur Praxis.",
  "Teach it, and earn from it.": "Transmettez-le, et vivez-en.",
  ...
  "About twenty dollars a month for the subscription. The tools you build run locally and do not charge per use.":
    "Environ vingt dollars par mois pour l'abonnement. Les outils que vous construisez tournent en local et ne facturent rien à l'usage.",
  ...
  "Not a generic example you have to translate. We start with the task that eats your week and build from there.":
    "Pas un exemple générique qu'il faut ensuite transposer. Nous partons de la tâche qui dévore votre semaine et construisons à partir de là.",
  "We meet you where you are": "Nous partons de là où vous en êtes",
  "No burying you in tools you have never heard of to look clever. Every session starts from where you actually are.":
    "Pas question de vous noyer sous des outils inconnus pour faire savant. Chaque séance part de votre niveau réel.",
  "The fiddly parts are where a guide earns their keep":
    "C'est dans les détails pénibles qu'un accompagnant se justifie",
  "Installing the tool, the first setup, the moment something breaks: that is exactly the part the free videos skip, and exactly where most people quietly give up.":
